...
public class Pawn extends Piece
{
    ...
    public boolean canMove(ChessBoard board, int preRank, int preFile, int newRank, int newFile)
    {
        ...
        checkIfDiffXValidWithPieceMoved = (this.pieceNotMoved && newFile - preFile == 2 * mvComp && newRank == preRank && board.squares[preRank][preFile + mvComp].piece == null && board.squares[newRank][newFile].piece == null);
